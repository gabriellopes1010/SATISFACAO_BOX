  ...
  return (
    ...
    <div className="pt-6">
      ...
      {!sucess && <div className="w-1/3 mx-auto  ">
        ...
        <input type='text' className=" p-4 block shadow bg-slate-200 rounded-full my-2 pr-64 pl-10" placeholder="Nome" onChange={onChange} name='Nome' value={form.Nome} />
        <label className="font-bold text-left">E-mail:</label>
        <input type='text' className="p-4 block shadow bg-slate-200 rounded-full my-2 pr-64 pl-10" placeholder="Email" onChange={onChange} name='Email' value={form.Email} />
        <label className="font-bold">Whatsapp:</label>
        <input type='text' className=" p-4 block shadow bg-slate-200 rounded-full my-2 pr-64 pl-10" placeholder="Whatsapp" onChange={onChange} name='Whatsapp' value={form.Whatsapp} />
